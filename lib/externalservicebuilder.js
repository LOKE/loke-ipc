...
exports = module.exports = function(serviceName, version) {
  ...
  Constructor.prototype.$start = function () {
    ...
    .then(function (serviceMeta) {
      ...
      console.log(serviceName, 'Methods now avalibale.');
    });
  };
